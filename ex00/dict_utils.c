...
/*   Updated: 2022/09/25 16:46:08 by dopeyrat         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "rush02.h"

int	ft_add_dict_bis(char *str, t_dict *dict, int i)
{
	int	j;
...
int	ft_add_dict(char *str, t_dict **start_dict)
{
	...
	while (str[i] == ' ' || (str[i] >= 9 && str[i] <= 13))
		i++;
	return (ft_add_dict_bis(str, dict, i));
}
